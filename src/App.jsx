...
import merchSameChipDifferentDay from './assets/merch/SameChipDifferentDay.png'
import merchNoChipSherlock from './assets/merch/NoChipSherlock.png'
import merchItsDoughTime from './assets/merch/ItsDoughTime.png'
import merchLetsDough from './assets/merch/LetsDough!!!.png'
import merchHowWeDoughIt from './assets/merch/ThisIsHowWeDoughIt.png'
...
import merchDontStartNoChip from "./assets/merch/Don'tStartChipWon'tBeChip.png"
...
import merchHolyChip from './assets/merch/HolyChip!.png'
...
const CHIP_SHIRTS = [
  ...
  { id: 27, name: "Don't Start Chip Won't Be Chip", img: merchDontStartNoChip },
...
import oatRegularNugsVideo from './assets/oatsession/oatsessionRegularNugs.mp4'
...
import ncNugsVideo from './assets/nutcase/NutCaseNugs.mp4'
...
const DOUGH_ITEMS = {
  Cookies: [
    ...
    { id: 26, name: 'Nut Case',             price: 5.00, emoji: '🥜', description: 'Peanut butter cookie filled with rich peanut butter chips and crunchy peanut candies.', styleVideos: { Chunks: ncVideo, Nugs: ncNugsVideo }, videoFirst: true },
    ...
    { id: 27, name: 'Berry Bomb',       price: 5.00, emoji: '🫐', description: 'Soft vanilla cookie stuffed with berry filling and topped with sweet vanilla icing and rainbow sprinkles.', variantDescriptions: { Blueberry: 'Soft vanilla cookie stuffed with blueberry filling and topped with sweet vanilla icing and rainbow sprinkles.', Strawberry: 'Soft vanilla cookie stuffed with strawberry filling and topped with sweet vanilla icing and rainbow sprinkles.' }, variants: ['Blueberry', 'Strawberry', 'Brown Sugar'], variantVideos: { 'Brown Sugar': berryBombBrownSugarVideo, Blueberry: berryBombBlueberryVideo, Strawberry: berryBombStrawberryVideo }, styleVideos: { Nugs: berryBombNugsVideo }, noNugs: true },
...
const BRIKS = [
  ...
  { id: 6,  name: 'Golden Toast', price: 25, description: 'Cinnamon Toast Crunch baked into a sweet, crispy treat.', video: goldenToastVideo, videoFirst: true },
...
function CancellationConfirmedPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', fontFamily: 'Arial, sans-serif' }}>
      <img src="/logowhite.png" alt="Dough Dealers" style={{ width: '140px', marginBottom: '32px', filter: 'invert(1)' }} />
      <div style={{ maxWidth: '420px', width: '100%', textAlign: 'center' }}>
...
export default function App() {
  ...
  if (params.get('cancelled') === '1') return <CancellationConfirmedPage />
