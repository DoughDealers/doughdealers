...
const DOUGH_ITEMS = {
  Cookies: [
    ...
    { id: 27, name: 'Berry Bomb',       price: 5.00, emoji: '🫐', description: 'Soft vanilla cookie stuffed with berry filling and topped with sweet vanilla icing and rainbow sprinkles.', variantDescriptions: { Blueberry: 'Soft vanilla cookie stuffed with blueberry filling and topped with sweet vanilla icing and rainbow sprinkles.' }, variants: ['Blueberry', 'Strawberry', 'Brown Sugar'], variantVideos: { 'Brown Sugar': berryBombBrownSugarVideo, Blueberry: berryBombBlueberryVideo, Strawberry: berryBombStrawberryVideo }, styleVideos: { Nugs: berryBombNugsVideo }, noNugs: true },
